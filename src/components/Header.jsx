  ...
  return (
    <header className="site-header">
      ...
      <div className="header-bar">
        ...
        <a className="brand" href="/" aria-label="Oscar Wylee home">
          <img src={logo} alt="Oscar Wylee" />
        </a>
        <nav className="desktop-nav" aria-label="Primary navigation">
          {navItems.map((item) => (
            <a className={item === 'Locations' ? 'active' : undefined} href="/" key={item}>
              {item}
            </a>
          ))}
        </nav>
        <div className="header-actions">
          ...
          <button className="bag-button" aria-label="Shopping bag with 2 items">
